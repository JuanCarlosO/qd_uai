...
require_once 'model/SiraModel.php';
    ...
    $input_id_frm = 'id="frm_edit_recomendaciones"';
    $ot = $_GET['ot'];
    $a = new SiraModel;
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">                         
                                ...
                                Formulario de edición del registro de irregularidades y recomendaciones para la OT: <b><?=$cedula[0]['clave'];?></b>                            
                            <br>
                    ...
                    <div class="box-body">
                        ...
                        <form <?=$input_id_frm?> method="post" action="#">              
                            <input type="hidden" id="option" name="option" value="146">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="f_acuse" name="f_acuse" class="form-control">
                                    </div>
                                </div>
