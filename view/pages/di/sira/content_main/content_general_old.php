                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select id="procedencia" name="procedencia" class="form-control" required>
                                            <option value="">...</option>
                                            <option value="1"<?=( $procedencia == 'SS' ) ? 'selected' : '' ;?>> SECRETARIA DE SEGURIDAD</option>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="lugar" name="lugar" maxlength="255" value="<?=$lugar?>" class="form-control" autocomplete="off" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
