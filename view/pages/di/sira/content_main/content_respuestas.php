                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form <?=$input_id_frm?> method="post" action="#">                      
                                <input type="hidden" id="option" name="option" value="117">
                                <input type="hidden" id="censo_id" name="censo_id" value="<?=$_GET['censo']?>">
                            
                            <!-- Elegir el tipo de envío para el registro del censo -->
                            <div class="row">
                                <div class="col-md-12">
                                    <label>Elija el tipo de vía de recepción de respuestas<i class="fa fa-asterisk text-red"></i></label>
                                </div>
                                <div class="col-md-3">
                                    <select id="question_res" name="question_res" class="form-control" required >
                                        <option value="">...</option>
                            ...
                            <div id="censo_oficio" class="hidden">
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <label>Periodo de solicitud</label>     
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Desde <i class="fa fa-asterisk text-red"></i></label>
                                            <input type="date" id="f_desde" name="f_desde" class="form-control" required>
                                        </div>
                                    </div>

                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Hasta <i class="fa fa-asterisk text-red"></i></label>
                                            <input type="date" id="f_hasta" name="f_hasta" class="form-control" required >
                                        </div>
                                    </div>
                                </div>                           
