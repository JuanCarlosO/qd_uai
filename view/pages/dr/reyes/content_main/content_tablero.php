            ...
            <div class="chart tab-pane active" id="sc">
                <div class="">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <table class="table table-bordered" id="tbl_resultado">
                                    <caption class="bg-gray text-center">
                                        <b>EXPEDIENTES CON RESULTADO</b>
                                    </caption>
                                    <thead>
                                        <tr>
                                            <th class="bg-gray text-center">NOTIFICADO</th>
                                            <th class="bg-gray text-center">NO NOTIFICADO</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="tbl_global" class="table table-bordered table-hover">
                                    <caption class=" bg-gray text-center"> LISTADO DE EXPEDIENTES</caption>
                                    <thead>
                                        <tr class="bg-gray">
