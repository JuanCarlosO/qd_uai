<div class="modal fade" id="modal_add_acuse">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Guardar acuse de recibido.</h4>
			</div>
			<div class="modal-body">
				<div id="div_acuse"></div>
				<form id="frm_add_acuse" action="#">
					<input type="hidden" id="option" name="option" value="89">
